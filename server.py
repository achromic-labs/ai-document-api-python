...
def index():
    ...
    try:
        ...
        if text:
            final_prompt = f"{prompt} to the following text: {text}. Please return only the text generated by the model and no additional context."
        else:
            final_prompt = f"Generated new text based on prompt: Prompt: {prompt}. Please return only the text generated by the model and no additional context."
