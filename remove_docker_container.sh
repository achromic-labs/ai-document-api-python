...
#
# Purpose:
#   Safely stops and removes the Docker container for the AI Document API service
...
#   2. Checks if container 'ai-document-api-python' exists
#   3. If exists:
...
#   - Container name: ai-document-api-python
